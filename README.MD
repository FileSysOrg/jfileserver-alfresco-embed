JFileServer - Alfresco Embedded Library
=======================================
...
The Alfresco embedded library removes a number of classes from the core JFileServer jar so that the
library can be used within the Spring environment.
